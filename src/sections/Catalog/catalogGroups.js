...

  {
    ...
    items: [
...

      {
        ...
        count: 10,
        description:'Цвет плода серо-зеленый \n Обладает отличным вкусом',
        price: 60,
        inStock: true,
      },

      {
        title: 'Профессор F1 — гибридный сорт белокочанной капусты',
        image: '/src/assets/images/Catalog/vegetables/Professor_F1.jpg',
        manufacturer: 'Производитель — Syngenta (Нидерланды)',
        parameters:'Масса кочана — 4-5 кг \n Сроки созревания — среднепоздний \n Вегетационный период — 120-125 дней ',
        count: 10,
        description:' Кочаны округло-плоской формы с высокой плотностью. \n Характеризуется длительной лежкостью в хранилищах — до 7 месяцев. \n Высокая устойчивость к бактериозу.',
        price: 90,
        inStock: true,
      },

      {
        title: 'Рокси F1 — позднеспелый гибрид краснокочанной капусты',
        image: '/src/assets/images/Catalog/vegetables/Roxy_F1.jpg',
        manufacturer: 'Производитель — Seminis (Нидерланды)',
        parameters:'Масса кочана — 2.5-3.5 кг \n Сроки созревания — 110-120 дней \n Устойчивость к растрескиванию ',
        count: 10,
        description:'Кочаны овальной формы, плотные, красно-синего цвета.  \n Подходит, как для переработки, так и для длительного хранения, а также для свежего потребления.',
        price: 80,
        inStock: true,
      },

      {
        title: 'Спейс Стар F1 — раннеспелый гибрид цветной капусты',
        image: '/src/assets/images/Catalog/vegetables/Space_Star_F1.jpg',
        manufacturer: 'Производитель — Syngenta (Нидерланды)',
        parameters:'Масса кочана — 2-3 кг \n Сроки созревания — 70-75 дней \n Растения отличаются мощностью и выровненостью ',
        count: 10,
        description:'Очень пластичный гибрид, хорошо переносит неблагоприятные условия, не любит избыточного азотного питания.  \n Высокие вкусовые качества.',
        price: 90,
        inStock: true,
      },
    ]
